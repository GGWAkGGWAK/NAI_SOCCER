...
Shader "Toony Colors Pro 2/Examples/SG2/Animated Dissolve_Custom"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
		...
		[NoScaleOffset] _SColor ("Shadow Color", 2D) = "white" {}
	...
	SubShader
	{
		...
		TCP2_TEX2D_WITH_SAMPLER(_SColor);
		...
		float4 fragment_outline (v2f_outline input) : SV_Target
		{
			...
			float __dissolveMap = ( tex2D_triplanar(_DissolveMap, float4(float2(1, 1) * _DissolveMap_ST.xy, _DissolveMap_ST.zw + frac(_Time.yy * _DissolveMap_SC.xy)), input.pack2.xyz, input.pack1.xyz) );
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			output.__shadowColor = ( TCP2_TEX2D_SAMPLE(_SColor, _SColor, input.texcoord0.xy).rgb );
...
/* TCP_DATA u config(ver:"2.9.6";unity:"2021.3.16f1";tmplt:"SG2_Template_Default";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","DISSOLVE","DISSOLVE_CLIP","DISSOLVE_GRADIENT","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","UNITY_2021_2","OUTLINE","TEXBLEND_NORMALIZE","WRAPPED_LIGHTING_HALF","RAMP_MAIN_OTHER","RAMP_SEPARATED","SHADOW_HSV_MASK","SHADOW_COLOR_LERP","ALBEDO_HSV_MASK","CRISP_RAMP_NO_AA"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",BLEND_TEX1_CHNL="r",BLEND_TEX2_CHNL="g",BLEND_TEX3_CHNL="b",BLEND_TEX4_CHNL="a"];shaderProperties:list[,,,,,,,sp(name:"Shadow Color";imps:list[imp_mp_texture(uto:False;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:3;chan:"RGB";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_SColor";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"66225dab-1a52-4abb-97d5-b5f874955c76";op:Multiply;lbl:"Shadow Color";gpu_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];clones:dict[];isClone:False),,,,sp(name:"Dissolve Map";imps:list[imp_mp_texture(uto:True;tov:"";tov_lbl:"";gto:False;sbt:False;scr:True;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:True;def:"gray";locked_uv:False;uv:6;cc:1;chan:"R";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:True;uv_type:Triplanar;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_DissolveMap";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"1bce4e69-5aa9-4194-8383-1f8da882010d";op:Multiply;lbl:"Map";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False),sp(name:"Dissolve Value";imps:list[imp_ct(lct:"_DissolveValue";cc:1;chan:"X";avchan:"X";guid:"60d36b91-8298-42c4-b1a6-116eb6e231f4";op:Multiply;lbl:"Value";gpu_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];clones:dict[];isClone:False),sp(name:"Dissolve Gradient Texture";imps:list[imp_mp_color(def:RGBA(1, 1, 1, 1);hdr:True;cc:4;chan:"RGBA";prop:"_DissolveGradientTexture";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"9cb5f671-20e0-4192-bfb3-38a15cbe6b6e";op:Multiply;lbl:"Gradient Texture";gpu_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];clones:dict[];isClone:False),,,,sp(name:"Vertex Position World";imps:list[imp_hook(guid:"e8830166-30da-4b68-8ec9-0b3c84d446dd";op:Multiply;lbl:"worldPos.xyz";gpu_inst:False;locked:False;impl_index:0),imp_customcode(prepend_type:Disabled;prepend_code:"";prepend_file:"";prepend_file_block:"";preprend_params:dict[];code:"+ pow({3}, 2) * v.vertex.y * float3(0,1,0)";guid:"7685fcb2-f26c-40f4-bf85-aa7470960080";op:Multiply;lbl:"Vertex Position World";gpu_inst:False;locked:False;impl_index:-1),imp_ct(lct:"_DissolveValue";cc:3;chan:"XXX";avchan:"X";guid:"6c6d296d-84e4-4ba5-acdd-2b1004ced2bb";op:Multiply;lbl:"Vertex Position World";gpu_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];clones:dict[];isClone:False),,,,,,,,,,,sp(name:"Shadow HSV Mask";imps:list[imp_ct(lct:"_ShadowMap";cc:1;chan:"A";avchan:"RGBA";guid:"f7bee8bc-f674-4963-b1c7-063f2336fd29";op:Multiply;lbl:"Shadow HSV Mask";gpu_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];clones:dict[];isClone:False)];customTextures:list[ct(cimp:imp_mp_range(def:0.5;min:0;max:1;prop:"_DissolveValue";md:"";gbv:False;custom:True;refs:"";pnlock:False;guid:"d25d99c3-bceb-4a5b-a3d0-8d46322040aa";op:Multiply;lbl:"Dissolve Value";gpu_inst:False;locked:False;impl_index:-1);exp:False;uv_exp:False;imp_lbl:"Range"),ct(cimp:imp_mp_texture(uto:False;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:4;chan:"RGBA";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_ShadowMap";md:"";gbv:False;custom:True;refs:"";pnlock:False;guid:"a61d1964-d897-4c3d-a770-3c6cfb1b999e";op:Multiply;lbl:"ShadowMap";gpu_inst:False;locked:False;impl_index:-1);exp:True;uv_exp:False;imp_lbl:"Texture")];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 2c24d6aa9378eb6b6c02b71c7872fa02 */
