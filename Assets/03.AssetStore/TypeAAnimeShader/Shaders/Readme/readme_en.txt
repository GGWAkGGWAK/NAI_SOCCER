...
--------------------------------------------------
TypeA/Toon02 (The following explanation is the same for 03.)
--------------------------------------------------
Rendering Settings
--------------------------------------------------
Rendering Mode
...
2021/11/21 v2.0.0
 ·Officially supported after Unity 2019.There are no functional changes.
 ·Each shader compatible with Unity 2018 or earlier remains in the state of v1.0.8.
