...
Shader "Vefects/SH_Vefects_VFX_AdvParticleMove"
{
	...
	SubShader
	{
		...
		uniform sampler2D _Erosion_Texture;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 panner79 = ( windSpeed200 * _Distortion_Speed + ( i.uv_texcoord.xy * _Distortion_Scale ));
			float Distortion64 = ( ( tex2D( _Distortion_Texture, panner79 ).r * 0.1 ) * _Distortion_Amount );
			float2 appendResult369 = (float2(_Mask_Offset.x , ( _Mask_Offset.x + i.uv_texcoord.w )));
			float2 uvs_TexCoord216 = i.uv_texcoord;
			uvs_TexCoord216.xy = i.uv_texcoord.xy * _Mask_Scale + appendResult369;
			...
			float2 panner78 = ( windSpeed200 * _Erosion_Speed + ( i.uv_texcoord.xy * _Erosion_Scale ));
			...
			o.Emission = ( ( ( ( float4( lerpResult353 , 0.0 ) * ( i.vertexColor * float4( (Color329).rgb , 0.0 ) ) ) * temp_output_344_0 ) * temp_output_309_0 ) * _EmissiveIntensity ).rgb;
...
/*ASEBEGIN
Version=18921
7;356;2122;1023;5367.421;-44.14328;1;True;True
...
Node;AmplifyShaderEditor.Vector2Node;219;-4553,483;Inherit;False;Property;_Mask_Offset;Mask_Offset;13;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;217;-4480,272;Inherit;False;Property;_Mask_Scale;Mask_Scale;12;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;283;-1919.328,-2344.922;Inherit;True;Property;_ColorGradientMask;Color Gradient Mask;2;0;Create;True;0;0;0;False;0;False;-1;None;3cba9d91c3e10304d9f23bab73d508f2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=07D0FF853C947200B6AC4D09DDDE593D63AD1FCC