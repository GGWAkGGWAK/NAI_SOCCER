...
namespace Minimalist.Bar.Quantity
{
    ...
    public class QuantityBhv : MonoBehaviour
    {
        ...
        public void UseSkillButtonA()
        {
            if(_currentAmount > 400.0f)
            {
                _currentAmount = _currentAmount - 400.0f;
            }
    

        }
        public void UseSkillButtonB()
        {
            if(_currentAmount > 300.0f)
            {
                _currentAmount = _currentAmount - 300.0f;
            }
          

        }
        public void UseShooting()
        {
            if(_currentAmount > 25.0f)
            {
                _currentAmount = _currentAmount - 25.0f;
            }
        }
